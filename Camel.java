...
public class Camel implements ActionListener{
	...
	JCheckBox c;
    	...
    	JLabel l1=new JLabel("Camels",img2,JLabel.LEFT);

	    l1.setForeground(new Color(100,100,100));
	    l1.setFont(new Font("SANS_Serif",Font.BOLD,65));
    
		
		ImageIcon img1= new ImageIcon("src/camels1.jpg");
		JLabel l=new JLabel("",img1,JLabel.LEFT);
	        l.setBounds(800, 50, 600, 400);
	    JLabel ta=new JLabel("Owned camels:");
		...
		ta1.setFont(new Font("sans-Serif", Font.BOLD, 18));
