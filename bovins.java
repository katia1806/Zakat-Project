...
public class bovins implements ActionListener{
	...
	ImageIcon img1= new ImageIcon("src/bovins.jpg");
	JLabel l=new JLabel("",img1,JLabel.LEFT);
        l.setBounds(770, 50, 500, 400);
